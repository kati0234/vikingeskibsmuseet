...
export const linkButtonStyles = tv({
  ...
  variants: {
    variant: {
      ...
      blue: "bg-blue-500 text-blue-50 text-bw-50  hover:bg-blue-800 rounded-3xl flex items-center gap-2  justify-center text-center   active:bg-blue-800 leading-tight disabled:bg-bw-700 disabled:cursor-not-allowed disabled:hover:bg-bw-700 ",
