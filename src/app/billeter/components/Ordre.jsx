...
export const OrdreoversigtTest = ({
  formData,
  totalPrice,
  discountAmount,
  finalPrice,
  ...
  return (
    <div className="space-y-4  p-4 w-[375px] rounded-lg bg-bw-100">
      <h3 className="font-semibold text-[28px]">Ordreoversigt</h3>
...
//   const handleApplyDiscount = () => {
//     setIsApplyingDiscount(true);
//     console.log("Klikket på Anvend");
//   };

//   useEffect(() => {
//     // Hvis der er en fejl, lad brugeren kunne redigere rabatkoden igen
//     if (errors.discountCode) {
//       setIsApplyingDiscount(false); // Stop loading når der er en fejl
//     }
//   }, [errors.discountCode]);
